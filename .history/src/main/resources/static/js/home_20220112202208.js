...
function validFailCheck() {
  ...
  if(document.getElementById("individual").checked){
    answer = document.getElementById("emailr").value +"/"+ document.getElementById("individual").value;  //w
  } else {
    answer = document.getElementById("emailr").value +"/"+ document.getElementById("company").value;  // email@test.com > email@test.com/c
  }
