...
public class LoginController {
     ...
     * 
     * @PostMapping("/login")
     * public String login(@ModelAttribute(name = "member") MemberDto memberDto,
     * BindingResult bindingResult) {
     * Member foundMember = loginService.login(memberDto.getEmail(),
     ...
     * 
     * // 로그인 성공
     * session.setAttribute(LoginConst.loginSession, new
     * MemberDto(foundMember.getEmail(), foundMember.getPassword()));
     * return "redirect:/";
     * }
     * 
     * @GetMapping("/logout")
