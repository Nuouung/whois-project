...
public class MemberController {
    ...
    @PostMapping("/signup")
    public String wJoinSubmit(NewMemberDto newMemberDto, AdditionalInfoDto additionalInfoDto) throws IOException {

        memberService.join(workerMemberDto, additionalInfoDto);
