...
public class MemberController {
    ...
    public String wJoinSubmit(WorkerMemberDto workerMemberDto, OptionalInfoDto optionalInfoDto) {
        System.out.println("dto : optionalInfoDto::prefMajor : " + optionalInfoDto.getPrefMajor());
