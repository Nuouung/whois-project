...
public class MemberController {
    ...
    @GetMapping("/join_echeck")
    public void checkAvailabilityEmail(String tempEmail, Model m) {
        System.out.println("controller : " + tempEmail);
        memberService.checkEmail(tempEmail, m);
    }
