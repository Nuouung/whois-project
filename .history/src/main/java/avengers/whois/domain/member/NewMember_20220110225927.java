...
public class NewMember {
    ...
    public NewMemberDto toDtoWOpw() {
        if (this.memberType == 'W') { // 당시 객체가 W타입, Worker면?
            return NewMemberDto.builder().fname(this.fname).phoneNumber(this.phoneNumber).birthDate(this.birthDate)
                    .address(this.address).createdDate(this.createdDate).modifiedDate(this.modifiedDate)
                    .gender(this.gender)
