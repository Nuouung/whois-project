...
public class MemberServiceImpl implements MemberService, UserDetailsService {
    ...
    // 있는 SecureDTO돌려줌
    @Override
    public UserDetails loadUserByUsername(String username, char memberType) throws UsernameNotFoundException {
        System.out.println("loadUserByUsername execute : " + username);
