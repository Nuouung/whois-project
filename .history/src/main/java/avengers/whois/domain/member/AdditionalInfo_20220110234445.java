...
public class AdditionalInfo {
    ...
    public AdditionalInfoDto toDto() {
        return AdditionalInfoDto.builder().ono(this.getOno()).prefJob(this.getPrefJob())
                .prefMajor(this.getPrefMajor()).prefExp(this.getPrefExp())
                .expMonths(this.getExpMonths()).newMember(this.getNewMember()).build();
    }
}
