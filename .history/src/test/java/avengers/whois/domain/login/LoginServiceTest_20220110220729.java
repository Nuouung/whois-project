...
class LoginServiceTest {
    ...
    void 유효개인회원_테스트() {
        ...
        // // when
        // Map<String, Member> loginMap = loginService.login(correctWorker.getEmail(),
        // correctWorker.getPassword(), correctWorker.getMemberType());
        // WorkerMember workerMember = (WorkerMember)
        // loginMap.get(LoginConst.MEMBER_WORKER);
    ...
    void 유효기업회원_테스트() {
        ...
        // Map<String, Member> loginMap = loginService.login(correctWorker.getEmail(),
        // correctWorker.getPassword(), correctWorker.getMemberType());
        // CorporateMember corporateMember = (CorporateMember)
        // loginMap.get(LoginConst.MEMBER_CORPORATION);
